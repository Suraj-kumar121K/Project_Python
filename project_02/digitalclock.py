...
lb_hr_txt = Label(clk, text = "Hour", font=("Time 20 bold",20,"bold"),bg = "#0875B7",fg="white")
...
lb_mn_txt = Label(clk, text = "SECOND", font=("Time 20 bold",20,"bold"),bg = "#008EA4",fg="white")
...
lb_sc_txt = Label(clk, text = "SECOND", font=("Time 20 bold",20,"bold"),bg = "#06B4B8",fg="white")
...
lb_dn_txt = Label(clk, text = "NOON", font=("Time 20 bold",20,"bold"),bg = "#9F0646",fg="white")
